...
Cifar10mnist_params = {"w": k, "a": torch.zeros(3),
                     ...
                     "num_model": 0,"main_dir": "logs/MDMTN_CM_logs", "mod_logdir": "MDMTN_model_CM_onek",
...
if __name__ == "__main__":
    ...
    # import os
    # directory_path = Cifar10mnist_params["main_dir"] 
    ...
    # print("CIFAR-10 Accuracy = ", Test_accuracy[0].item())
    # print("MNIST Accuracy = ", Test_accuracy[1].item())
