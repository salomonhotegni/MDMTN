...
class MNIST(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.multi:
            if self.train:
                img, target_l_and_target_r = self.train_data[index], (self.train_labels_l[index], self.train_labels_r[index])
            else:
                img, target_l_and_target_r = self.test_data[index], (self.test_labels_l[index], self.test_labels_r[index])
        else:
            if self.train:
